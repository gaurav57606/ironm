...
class InvoiceScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final member = ref.watch(membersProvider).firstWhere((m) => m.memberId == memberId);
  ...
  Widget _buildInvoiceCard(dynamic member, dynamic payment) {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text('#${payment?.invoiceId ?? "INV-2026-0142"}', style: AppTextStyles.label.copyWith(fontSize: 9, color: AppColors.textSecondary)),
                ],
              ),
            ],
          ),
