...
class AppTextStyles {
  ...
  static TextStyle get title => _font(fontSize: 18, fontWeight: FontWeight.w700, color: AppColors.textPrimary);
  ...
  static TextStyle get subtext => _font(fontSize: tinySize, fontWeight: FontWeight.w400, color: AppColors.textSecondary);
